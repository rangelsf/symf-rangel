<?php
    ...
    public function new(Request $request)
    {
        ...
        ->add('save', SubmitType::class, array('label' => 'Criar', 'attr' => array('class' => 'btn btn-primary mt-3')))
        ->getForm();
    ...
    //     $article = new Article();
    //     $article->setTitle('Artigo dois');
    //     $article->setBody('Corpo artigo dois');

    //     $entityManager->persist($article);
    //     $entityManager->flush();

    //     return new Response('Salvou um artigo com ID de '. $article->getId());
    // }
    }
